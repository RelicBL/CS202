...
int main(int argc, char *argv[])
{
	...
	{ 
		...
		read_file(argv[2], cust);	// Input from file
	else
		read_cust_info(cin, cust, 1);	// Interactive data input
...
NOTES:             int argc, // Number of parameters on the command line
		   char *argv[] //An array of pointers to C-strings
------------------------------------------------------------------------------- */
void read_file(char * file, Customer *s)
{
	...
	else
	{
		...
		read_cust_info(infile, s, 0);	// Input without prompts
		infile.close();
	}
}
/* -----------------------------------------------------------------------------
